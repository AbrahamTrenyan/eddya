...
Para ello se pide: Día de vuelo, nombre de la ciudad, capacidad del avión y cantidad depasajes vendidos. Estos datos se ingresan hasta que el día de vuelo sea cero.
